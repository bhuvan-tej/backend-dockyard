package com.dockyard.java11features.exception;
 ...
 * exceptions some demo services throw (e.g. file I/O errors from
 * {@code Files.readString}, network errors from {@code HttpClient}) into a
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleIo(Exception ex, HttpServletRequest request) {
